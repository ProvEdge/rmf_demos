    ...
    <>
      <div className='menu-item'>
        <div className='menu-content pt-8 pb-2'>
          <span className='menu-section text-muted text-uppercase fs-8 ls-1'>Robotics</span>
        </div>
      </div>
      <AsideMenuItem
        to='/fleet'
      ...
      <div className='menu-item'>
        <div className='menu-content pt-8 pb-2'>
          <span className='menu-section text-muted text-uppercase fs-8 ls-1'>Cloud</span>
        </div>
      </div>
      <AsideMenuItem
        to='/clusters'
      ...
      >
        ...
        <AsideMenuItemWithSub to='/error/500' title='Workloads' hasBullet={false}>
          <AsideMenuItem to='/deployments' title='Deployments' hasBullet={true} />
          <AsideMenuItem to='/stateful-sets' title='Stateful Sets' hasBullet={true} />
          <AsideMenuItem to='/daemon-sets' title='Daemon Sets' hasBullet={true} />
        ...
        <AsideMenuItemWithSub to='/error/500' title='Storage' hasBullet={false}>
          <AsideMenuItem to='/storage-classes' title='Storage Classes' hasBullet={true} />
          <AsideMenuItem to='/persistent-volumes' title='Persistent Volumes' hasBullet={true} />
          <AsideMenuItem
        ...
        <AsideMenuItemWithSub to='/error/500' title='Networking' hasBullet={false}>
          <AsideMenuItem to='/services' title='Services' hasBullet={false} />
          <AsideMenuItem to='/ingresses' title='Ingresses' hasBullet={false} />
        </AsideMenuItemWithSub>

        <AsideMenuItemWithSub to='/error/500' title='Configuration' hasBullet={false}>
          <AsideMenuItem to='/config-maps' title='ConfigMaps' hasBullet={false} />
          <AsideMenuItem to='/secrets' title='Secrets' hasBullet={false} />
        </AsideMenuItemWithSub>
        <AsideMenuItemWithSub to='/error/500' title='Monitoring' hasBullet={false}>
